...
This section describes how to install, use, and manage YESDR using the official APT package repository. [Get started with YESDR installation](Installation.md).
